...
<ParamField path="max_history_days" type="int" default="1460">
  Number of days of history to retrieve, counting back from the previous UTC day. Only used when `earliest_history_date` is not set. Defaults to `365 * 4` (approximately four years).
</ParamField>
