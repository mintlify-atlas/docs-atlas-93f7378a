---
title: "Download Google Purchases History from Gmail"
sidebarTitle: "Google Purchases"
description: "Scrape purchases that Google extracted from Gmail using finance_dl.google_purchases. Downloads order detail HTML and JSON files in Google Takeout format."
---
