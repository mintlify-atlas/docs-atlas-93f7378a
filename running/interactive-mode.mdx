---
title: "Debug Scrapers with finance-dl Interactive Mode"
sidebarTitle: "Interactive Mode"
description: "Launch an IPython shell to manually drive scrapers, inspect page state, debug login flows, and complete MFA challenges during development or troubleshooting."
---
...
For the Mint scraper, the run function takes explicit arguments:
